...
roslaunch sick_lidar_localization sim_loc_driver_check.launch sim_loc_driver_check_cfg:=message_check_demo.yaml    2>&1 | unbuffer -p tee -a ~/.ros/log/sim_loc_driver_check_demo.log    &
roslaunch sick_lidar_localization sim_loc_driver_check.launch sim_loc_driver_check_cfg:=message_check_default.yaml 2>&1 | unbuffer -p tee -a ~/.ros/log/sim_loc_driver_check_default.log &
