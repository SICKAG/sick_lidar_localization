...
./gen_service_call LocInitializeAtPose POST "{\"data\":{\"x\":1000,\"y\":1000,\"yaw\":1000,\"searchRadius\":1000}}" --hostname=localhost --verbose=1 --dump=1 --append=linux_unittest_gen_sick_caller.log
./gen_service_call LocLoadMapToCache POST "{\"data\":{\"mapPath\":\"test.vmap\"}}" --hostname=localhost --verbose=1 --dump=1 --append=linux_unittest_gen_sick_caller.log
./gen_service_call LocRequestTimestamp POST "{}" --hostname=localhost --verbose=1 --dump=1 --append=linux_unittest_gen_sick_caller.log
./gen_service_call LocResumeAtPose POST "{\"data\":{\"x\":1000,\"y\":1000,\"yaw\":1000}}" --hostname=localhost --verbose=1 --dump=1 --append=linux_unittest_gen_sick_caller.log
./gen_service_call LocSaveRingBufferRecording POST "{\"data\":{\"reason\":\"YYYY-MM-DD_HH-MM-SS pose quality low\"}}" --hostname=localhost --verbose=1 --dump=1 --append=linux_unittest_gen_sick_caller.log
./gen_service_call LocSetKinematicVehicleModelActive POST "{\"data\":{\"active\":1}}" --hostname=localhost --verbose=1 --dump=1 --append=linux_unittest_gen_sick_caller.log
./gen_service_call LocSetLinesForSupportActive POST "{\"data\":{\"active\":1}}" --hostname=localhost --verbose=1 --dump=1 --append=linux_unittest_gen_sick_caller.log
./gen_service_call LocSetMap POST "{\"data\":{\"mappath\":\"test.vmap\"}}" --hostname=localhost --verbose=1 --dump=1 --append=linux_unittest_gen_sick_caller.log
./gen_service_call LocSetMappingActive POST "{\"data\":{\"active\":1}}" --hostname=localhost --verbose=1 --dump=1 --append=linux_unittest_gen_sick_caller.log
