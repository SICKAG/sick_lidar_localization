...
for ((n=0;n<1;n++)) ; do
  ...
  call_service SickDevSetLidarConfig sick_lidar_localization/srv/SickDevSetLidarConfigSrv "{index: 0, minrange: 100, maxrange: 200000, minangle: -15000, maxangle: 15000, x: 1000, y: -1000, yaw: 2000, upsidedown: true, ip: 192.168.1.30, port: 2111, interfacetype: 0, maplayer: 0, active: true}" "set=True, executed=True"
  call_service SickDevGetLidarConfig sick_lidar_localization/srv/SickDevGetLidarConfigSrv "{scannerindex: 0}" "minrange=100, maxrange=200000, minangle=-15000, maxangle=15000, x=1000, y=-1000, yaw=2000, upsidedown=True, ip='192.168.1.30', port=2111, interfacetype=0, maplayer=0, active=True"
  # call_service SickDevSetLidarConfig sick_lidar_localization/srv/SickDevSetLidarConfigSrv "{index: 0, minrange: 1, maxrange: 3, minangle: 0, maxangle: 2, x: 0, y: 0, yaw: 0, upsidedown: true, ip: 192.168.0.30, port: 2111, interfacetype: 0, maplayer: 0, active: true}" "set=True, executed=True"
  # call_service SickDevGetLidarConfig sick_lidar_localization/srv/SickDevGetLidarConfigSrv "{scannerindex: 0}" "minrange=1, maxrange=3, minangle=0, maxangle=2, x=0, y=0, yaw=0, upsidedown=True, ip='192.168.0.30', port=2111, interfacetype=0, maplayer=0, active=True"
  # ros2 service call SickLocColaTelegram sick_lidar_localization/srv/SickLocColaTelegramSrv "{cola_ascii_request: 'sMN DevSetLidarConfig +0 +300 +100000 -180000 +180000 +1000 -300 -45000 0 +12 192.168.0.30 +2122 0 0 1', wait_response_timeout: 1}"
  ...
  call_service SickLocInitializePose sick_lidar_localization/srv/SickLocInitializePoseSrv "{x: 100, y: -100, yaw: 2000, sigmatranslation: 1000}" "success=True"
  ...
  call_service SickLocInitialPose sick_lidar_localization/srv/SickLocInitialPoseSrv "{}" "x=100, y=-100, yaw=2000, sigmatranslation=1000, success=True"
